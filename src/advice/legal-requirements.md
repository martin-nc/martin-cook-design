...
The EU plans to revise its cookie regulations, and replace the ePrivacy Directive (EPD) with the [ePrivacy Regulation (EPR)](https://digital-strategy.ec.europa.eu/en/policies/eprivacy-regulation). The Regulation is still being discussed, however.

In the UK, the Data (Use and Access) Act 2025 allows you to use more cookies without consent, such as those to collect site certain statistics. For example, you can collect **_aggregated_** statistics about the usage of the site (like page views) but not about the individual users of the site. See the [ICO website](https://ico.org.uk/about-the-ico/what-we-do/legislation-we-cover/data-use-and-access-act-2025/the-data-use-and-access-act-2025-what-does-it-mean-for-organisations/#prepare) for an overview of all the changes, and the [exceptions page](https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guidance-on-the-use-of-storage-and-access-technologies/what-are-the-exceptions#statistical) for details about cookie exceptions.
...
The international standards for accessibility are created by the World Wide Web Consortium (W3C), and are called the [Web Content Accessibility Guidelines](https://www.w3.org/WAI/standards-guidelines/) (see the [simple overview](https://www.w3.org/WAI/standards-guidelines/wcag/glance/)). There are three levels of conformance to these guidelines:
...
Just a reminder that just because content is on the web, it doesn’t mean you can use it. If you want stock photos and videos, don’t forget you can get them for free on sites like [Pexels](https://www.pexels.com/), [Unsplash](https://unsplash.com/) and [Pixabay](https://pixabay.com/).
